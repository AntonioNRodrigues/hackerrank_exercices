    ...
    class Result {
        ...
        public static List<Integer> countingSort(List<Integer> arr) {
            ...
            for (int i = 0; i < arr.size(); i++) {
                int indexOfResult = arr.get(i);
                int currentValue = resultArr[indexOfResult];
                currentValue += 1;
                resultArr[indexOfResult] = currentValue;
            }

            return  Arrays.stream(resultArr).boxed().collect(toList());
